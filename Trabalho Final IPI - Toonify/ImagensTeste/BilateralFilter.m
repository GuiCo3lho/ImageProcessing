function [ImgBilateralFiltered] = BilateralFilter(ImagemEntrada)
    ...
    ImgBilateralFiltered = zeros(linhas,colunas);
    ...
    for i=1:linhas
      for j=1:colunas
         ...
         ImgBilateralFiltered(i,j) = sum(FiltroBilateral.*Elemento_Estruturante)/sum(FiltroBilateral);
       end
    end
end